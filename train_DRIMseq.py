...
system.train_agent(initialization=initialization, skill_learning=skill_learning, storing_path=path, rewards=rewards, metrics=metrics, iter_0=last_iter, q_learning=q_learning, concept_learning=concept_learning)
